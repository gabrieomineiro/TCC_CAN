//============================================================
// Monitor do BTU.
// Amostra todos os sinais a cada ciclo via mon_cb e publica um
// can_btu_seq_item por ciclo (campos de observação).
//============================================================
class can_btu_monitor extends uvm_monitor;
    ...
    task run_phase(uvm_phase phase);
        ...
        forever begin
            @(vif.mon_cb);
            item = can_btu_seq_item::type_id::create("mon_item");

            // Entradas (configuração + barramento + sync + reset)
